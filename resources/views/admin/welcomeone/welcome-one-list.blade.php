          ...
          <tbody>
              ...
              <tr>
                ...
                <td>
                  ...
                  {{-- <form action="{{ route('welcome_ones.destroy', ['welcome_one' => $welcomeone->id]) }}" method="post" onsubmit="return confirm('are you sure you want to delete ?')">
                    @csrf
                    @method('delete')
